...
# CMD sleep 3600
CMD node testnet-generate-env.js && service cron start && pm2 start ecosystem.config.cjs && service redis-server start && mongod --fork -f /etc/mongod.conf || sleep infinity